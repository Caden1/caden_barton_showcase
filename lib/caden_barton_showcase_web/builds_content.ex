  ...
  def projects do
    [
      %{
        ...
        approach: "Phoenix contexts with LiveView streams, structured telemetry, and playbooks surfaced inline for operators.",
      ...
      %{
        ...
        approach: "Modeled schemas for ClickHouse, enforced contracts at ingress, and tuned consumers with budgets and retries.",
      ...
      %{
        ...
        approach: "Per-tenant boundary modules, scoped queries, and migration playbooks with feature flags and backfills.",
